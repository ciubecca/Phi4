...
minoverlaplist = [10**(-2), 3*10**(-3), 10**(-3)]
...
plt.title(r"$g$={0:.1f}, $L$={1:.1f}, $E_T$={2:.1f}".format(g,L,ET))
...
plt.savefig("figs/fig_E0vsEL3_g={0:.1f}_L={1:.1f}_ET={2:.1f}.{3}"
        .format(g,L,ET,output))
...
plt.savefig("figs/fig_MvsEL3_g={0:.1f}_L={1:.1f}_ET={2:.1f}.{3}"
        .format(g,L,ET,output))
...
plt.savefig("figs/fig_E1vsEL3_g={0:.1f}_L={1:.1f}_ET={2:.1f}.{3}"
        .format(g,L,ET,output))
# plt.savefig("figs/fig_MvsET_g={0:.1f}_L={1:.1f}_EL={2:.1f}.{3}"
        # .format(g,L,EL,output))
