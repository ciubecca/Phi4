basis sizes : 12870 12801
         27904862 function calls (27894310 primitive calls) in 43.885 seconds

   Ordered by: internal time

   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
    77013   12.914    0.000   27.700    0.000 oscillators.py:84(computeMatrixElements)
   442530    9.998    0.000    9.998    0.000 oscillators.py:155(<listcomp>)
 10648081    4.866    0.000    9.009    0.000 statefuncs.py:108(<genexpr>)
 10530706    4.172    0.000    4.303    0.000 {built-in method builtins.sorted}
       10    2.581    0.258   11.590    1.159 statefuncs.py:108(<listcomp>)
   585110    2.145    0.000    2.145    0.000 {method 'reduce' of 'numpy.ufunc' objects}
   930539    1.110    0.000    1.110    0.000 {built-in method numpy.core.multiarray.array}
   885060    0.980    0.000    0.980    0.000 {method 'diagonal' of 'numpy.ndarray' objects}
        2    0.845    0.422    0.845    0.422 coo.py:380(diagonal)
   442530    0.420    0.000    2.418    0.000 {method 'prod' of 'numpy.ndarray' objects}
   533004    0.411    0.000    0.411    0.000 {built-in method _bisect.bisect_left}
        1    0.284    0.284   30.253   30.253 phi4.py:40(buildMatrix)
    88393    0.256    0.000    0.256    0.000 {built-in method builtins.sum}
   442530    0.230    0.000    0.230    0.000 {method 'tolist' of 'numpy.ndarray' objects}
   462198    0.226    0.000    2.122    0.000 _methods.py:34(_prod)
    25671    0.223    0.000    0.223    0.000 statefuncs.py:62(<dictcomp>)
        2    0.194    0.097   12.786    6.393 statefuncs.py:77(__init__)
        1    0.151    0.151   43.885   43.885 genMatrix.py:1(<module>)
    77013    0.125    0.000    0.334    0.000 statefuncs.py:39(energy)
    45867    0.097    0.000    0.288    0.000 __init__.py:512(__init__)
        1    0.087    0.087    0.485    0.485 statefuncs.py:178(buildBasis)
        4    0.082    0.021    0.082    0.021 {built-in method scipy.sparse._sparsetools.csr_sort_indices}
    94688    0.079    0.000    0.284    0.000 fromnumeric.py:1743(sum)
        2    0.076    0.038    0.517    0.258 statefuncs.py:86(<listcomp>)
        2    0.066    0.033    0.121    0.061 statefuncs.py:90(<listcomp>)
    45867    0.062    0.000    0.187    0.000 __init__.py:581(update)
     7084    0.061    0.000    0.088    0.000 statefuncs.py:59(<listcomp>)
    13112    0.055    0.000    0.274    0.000 oscillators.py:11(bose)
    25671    0.052    0.000    0.415    0.000 statefuncs.py:61(repr2torepr1)
   143241    0.046    0.000    0.115    0.000 {built-in method builtins.isinstance}
    19668    0.043    0.000    0.167    0.000 fromnumeric.py:2395(prod)
    45867    0.042    0.000    0.069    0.000 abc.py:178(__instancecheck__)
        6    0.041    0.007    0.041    0.007 {built-in method scipy.sparse._sparsetools.coo_tocsr}
    25675    0.040    0.000    0.040    0.000 {built-in method numpy.core.multiarray.concatenate}
      528    0.039    0.000    0.410    0.001 oscillators.py:78(<listcomp>)
   114961    0.038    0.000    0.038    0.000 statefuncs.py:54(omega)
   7329/1    0.037    0.000    0.175    0.175 statefuncs.py:156(genRMlist)
    17675    0.033    0.000    0.107    0.000 statefuncs.py:42(RMenergy)
    51/38    0.030    0.001    0.044    0.001 {built-in method _imp.create_dynamic}
   219875    0.028    0.000    0.028    0.000 {method 'get' of 'dict' objects}
    37718    0.028    0.000    0.052    0.000 statefuncs.py:49(<listcomp>)
     6556    0.027    0.000    0.042    0.000 oscillators.py:79(<listcomp>)
    66088    0.027    0.000    0.027    0.000 _weakrefset.py:70(__contains__)
    37718    0.024    0.000    0.095    0.000 statefuncs.py:48(oscEnergy)
184186/184148    0.023    0.000    0.023    0.000 {built-in method builtins.len}
    94688    0.023    0.000    0.190    0.000 _methods.py:31(_sum)
      229    0.022    0.000    0.022    0.000 {built-in method marshal.loads}
        2    0.021    0.011    0.149    0.074 phi4.py:54(<listcomp>)
        1    0.020    0.020    0.737    0.737 oscillators.py:188(Phi4Operators)
    25671    0.020    0.000    0.025    0.000 __init__.py:550(elements)
        2    0.018    0.009    0.018    0.009 {built-in method scipy.sparse._sparsetools.csr_plus_csr}
       17    0.017    0.001    0.017    0.001 {method 'astype' of 'numpy.ndarray' objects}
        8    0.016    0.002    0.016    0.002 {method 'copy' of 'numpy.ndarray' objects}
        1    0.013    0.013   43.545   43.545 genMatrix.py:10(main)
     8013    0.013    0.000    0.035    0.000 statefuncs.py:45(RMtotalWN)
    25722    0.013    0.000    0.013    0.000 {method 'update' of 'dict' objects}
        3    0.011    0.004    0.666    0.222 oscillators.py:21(__init__)
    260/1    0.011    0.000   43.885   43.885 {built-in method builtins.exec}
      528    0.010    0.000    0.159    0.000 oscillators.py:67(<listcomp>)
    25671    0.010    0.000    0.055    0.000 {method 'all' of 'numpy.ndarray' objects}
        2    0.010    0.005    0.010    0.005 {built-in method scipy.sparse._sparsetools.csr_minus_csr}
  463/458    0.009    0.000    0.015    0.000 {built-in method builtins.__build_class__}
    20196    0.009    0.000    0.009    0.000 {built-in method _collections._count_elements}
    17874    0.008    0.000    0.008    0.000 {built-in method builtins.min}
        4    0.008    0.002    0.008    0.002 {built-in method scipy.sparse._sparsetools.csr_sum_duplicates}
    25673    0.008    0.000    0.008    0.000 statefuncs.py:145(__getitem__)
     7084    0.007    0.000    0.119    0.000 statefuncs.py:57(repr1torepr2)
        2    0.007    0.004    0.118    0.059 statefuncs.py:92(<listcomp>)
    25671    0.006    0.000    0.045    0.000 _methods.py:40(_all)
    17701    0.006    0.000    0.006    0.000 {built-in method math.floor}
      528    0.006    0.000    0.037    0.000 oscillators.py:73(<listcomp>)
    16991    0.006    0.000    0.110    0.000 statefuncs.py:71(occn)
        2    0.006    0.003    0.116    0.058 statefuncs.py:93(<listcomp>)
        2    0.005    0.003    0.013    0.007 machar.py:116(_do_init)
     ...
     1121    0.005    0.000    0.005    0.000 {built-in method posix.stat}
    26225    0.004    0.000    0.004    0.000 {built-in method math.sqrt}
        2    0.004    0.002    0.004    0.002 {built-in method scipy.sparse._sparsetools.expandptr}
        2    0.004    0.002    0.029    0.014 data.py:98(_mul_scalar)
    37336    0.004    0.000    0.004    0.000 {method 'append' of 'list' objects}
      231    0.003    0.000    0.005    0.000 <frozen importlib._bootstrap_external>:816(get_data)
    ...
    25671    0.003    0.000    0.003    0.000 {built-in method from_iterable}
     4472    0.003    0.000    0.003    0.000 {built-in method builtins.hasattr}
      325    0.002    0.000    0.028    0.000 <frozen importlib._bootstrap>:879(_find_spec)
    25711    0.002    0.000    0.002    0.000 {method 'items' of 'dict' objects}
    14537    0.002    0.000    0.002    0.000 {built-in method math.factorial}
    285/2    0.002    0.000    0.189    0.094 <frozen importlib._bootstrap>:659(_load_unlocked)
     ...
     2505    0.002    0.000    0.010    0.000 fromnumeric.py:1892(any)
    ...
    356/2    0.002    0.000    0.189    0.095 <frozen importlib._bootstrap>:966(_find_and_load)
     3085    0.002    0.000    0.002    0.000 {built-in method builtins.getattr}
     2190    0.002    0.000    0.002    0.000 {method 'format' of 'str' objects}
      231    0.002    0.000    0.002    0.000 {method 'read' of '_io.FileIO' objects}
    ...
    21525    0.002    0.000    0.002    0.000 {built-in method builtins.abs}
     ...
     2998    0.002    0.000    0.002    0.000 numeric.py:484(asanyarray)
    ...
    356/2    0.001    0.000    0.189    0.095 <frozen importlib._bootstrap>:939(_find_and_load_unlocked)
      656    0.001    0.000    0.002    0.000 <frozen importlib._bootstrap>:119(release)
      321    0.001    0.000    0.023    0.000 <frozen importlib._bootstrap_external>:1101(_get_spec)
 1287/590    0.001    0.000    0.095    0.000 <frozen importlib._bootstrap>:996(_handle_fromlist)
     2505    0.001    0.000    0.006    0.000 {method 'any' of 'numpy.ndarray' objects}
     ...
     2485    0.001    0.000    0.001    0.000 <frozen importlib._bootstrap_external>:366(_verbose_message)
    ...
    39/21    0.001    0.000    0.002    0.000 sre_parse.py:491(_parse)
     ...
     2233    0.001    0.000    0.001    0.000 {method 'rpartition' of 'str' objects}
    230/2    0.001    0.000    0.189    0.094 <frozen importlib._bootstrap_external>:659(exec_module)
     2505    0.001    0.000    0.005    0.000 _methods.py:37(_any)
       17    0.001    0.000    0.013    0.001 __init__.py:356(namedtuple)
  285/257    0.001    0.000    0.052    0.000 <frozen importlib._bootstrap>:570(module_from_spec)
      300    0.001    0.000    0.002    0.000 <frozen importlib._bootstrap>:195(_lock_unlock_module)
     1121    0.001    0.000    0.005    0.000 <frozen importlib._bootstrap_external>:68(_path_stat)
       12    0.001    0.000    0.040    0.003 coo.py:217(_check)
      229    0.001    0.000    0.023    0.000 <frozen importlib._bootstrap_external>:474(_compile_bytecode)
   378/41    0.001    0.000    0.109    0.003 {built-in method builtins.__import__}
     ...
     1993    0.001    0.000    0.001    0.000 {built-in method builtins.max}
      ...
      461    0.001    0.000    0.001    0.000 <frozen importlib._bootstrap_external>:56(_path_split)
    76/21    0.000    0.000    0.003    0.000 sre_compile.py:64(_compile)
        6    0.000    0.000    0.001    0.000 enum.py:88(__new__)
      413    0.000    0.000    0.002    0.000 <frozen importlib._bootstrap_external>:78(_path_is_mode_type)
      ...
      651    0.000    0.000    0.001    0.000 numeric.py:414(asarray)
       91    0.000    0.000    0.000    0.000 {built-in method __new__ of type object at 0x7f27eb747360}
      694    0.000    0.000    0.000    0.000 sre_parse.py:226(__next)
      229    0.000    0.000    0.000    0.000 {built-in method _imp._fix_co_filename}
   ...
   122/67    0.000    0.000    0.000    0.000 sre_parse.py:167(getwidth)
    ...
    436/2    0.000    0.000    0.188    0.094 <frozen importlib._bootstrap>:214(_call_with_frames_removed)
      ...
      230    0.000    0.000    0.001    0.000 <frozen importlib._bootstrap_external>:826(path_stats)
        6    0.000    0.000    0.142    0.024 coo.py:301(tocsr)
      459    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:45(_r_long)
        1    0.000    0.000   13.271   13.271 phi4.py:35(buildBasis)
     ...
     1313    0.000    0.000    0.000    0.000 {built-in method _thread.get_ident}
        4    0.000    0.000    0.095    0.024 compressed.py:1076(_binopt)
     ...
     1249    0.000    0.000    0.000    0.000 {method 'startswith' of 'str' objects}
       ...
       12    0.000    0.000    0.324    0.027 coo.py:116(__init__)
      481    0.000    0.000    0.001    0.000 type_check.py:141(imag)
       53    0.000    0.000    0.000    0.000 {built-in method numpy.core.multiarray.empty}
    ...
    72/70    0.000    0.000    0.007    0.000 <frozen importlib._bootstrap>:972(_gcd_import)
      460    0.000    0.000    0.000    0.000 {built-in method from_bytes}
        2    0.000    0.000    0.162    0.081 base.py:279(__add__)
        2    0.000    0.000    0.083    0.042 compressed.py:331(__add__)
    ...
    14/10    0.000    0.000    0.066    0.007 compressed.py:24(__init__)
    ...
    51/38    0.000    0.000    0.045    0.001 <frozen importlib._bootstrap_external>:903(create_module)
    ...
    35/21    0.000    0.000    0.002    0.000 sre_parse.py:429(_parse_sub)
      ...
      412    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap>:190(cb)
       ...
       35    0.000    0.000    0.000    0.000 _inspect.py:67(getargs)
        2    0.000    0.000    0.026    0.013 compressed.py:915(tocoo)
    ...
    36/35    0.000    0.000    0.007    0.000 <frozen importlib._bootstrap>:1043(__import__)
      ...
      256    0.000    0.000    0.000    0.000 <frozen importlib._bootstrap_external>:1184(<genexpr>)
       ...
       27    0.000    0.000    0.000    0.000 core.py:863(__init__)
        ...
        1    0.000    0.000    0.016    0.016 __init__.py:205(<module>)
      ...
      110    0.000    0.000    0.001    0.000 re.py:160(match)
       32    0.000    0.000    0.000    0.000 _weakrefset.py:58(__iter__)
        1    0.000    0.000    0.054    0.054 __init__.py:108(<module>)
      ...
      154    0.000    0.000    0.000    0.000 base.py:99(get_shape)
        1    0.000    0.000   13.271   13.271 statefuncs.py:112(fromScratch)
      ...
      112    0.000    0.000    0.000    0.000 sre_parse.py:153(__len__)
       ...
       23    0.000    0.000    0.000    0.000 core.py:6348(getdoc)
        ...
        2    0.000    0.000    0.025    0.012 coo.py:430(_with_data)
      124    0.000    0.000    0.000    0.000 {method 'find' of 'bytearray' objects}
       ...
       10    0.000    0.000    0.000    0.000 getlimits.py:151(<lambda>)
        2    0.000    0.000   11.590    5.795 statefuncs.py:108(<dictcomp>)
      ...
      328    0.000    0.000    0.000    0.000 {built-in method _sre.getlower}
       ...
       12    0.000    0.000    0.093    0.008 base.py:202(asformat)
       ...
       24    0.000    0.000    0.019    0.001 _methods.py:25(_amax)
   ...
   104/84    0.000    0.000    0.000    0.000 {built-in method builtins.issubclass}
      ...
      176    0.000    0.000    0.000    0.000 {method 'add' of 'set' objects}
       ...
       90    0.000    0.000    0.000    0.000 {method '__contains__' of 'frozenset' objects}
        ...
        5    0.000    0.000    0.014    0.003 getlimits.py:94(__new__)
       ...
       22    0.000    0.000    0.000    0.000 base.py:887(isspmatrix)
        ...
        4    0.000    0.000    0.027    0.007 matrix.py:40(to)
        1    0.000    0.000    0.014    0.014 decomp_schur.py:1(<module>)
        2    0.000    0.000    0.029    0.014 matrix.py:33(__mul__)
      ...
      184    0.000    0.000    0.000    0.000 {built-in method builtins.ord}
       ...
       11    0.000    0.000    0.000    0.000 sre_parse.py:78(opengroup)
        ...
        1    0.000    0.000    0.006    0.006 statefuncs.py:190(<listcomp>)
       19    0.000    0.000    0.000    0.000 tokenize.py:111(group)
        2    0.000    0.000    0.013    0.007 machar.py:98(__init__)
       ...
       16    0.000    0.000    0.000    0.000 sputils.py:182(isintlike)
        ...
        1    0.000    0.000    0.002    0.002 oscillators.py:1(<module>)
      ...
      124    0.000    0.000    0.000    0.000 inspect.py:2434(name)
        ...
        2    0.000    0.000    0.029    0.014 base.py:292(__mul__)
      ...
      103    0.000    0.000    0.000    0.000 inspect.py:2438(default)
       ...
       19    0.000    0.000    0.006    0.000 re.py:222(compile)
        ...
        1    0.000    0.000    0.026    0.026 lgmres.py:4(<module>)
       ...
       11    0.000    0.000    0.000    0.000 sre_parse.py:90(closegroup)
        1    0.000    0.000   12.786   12.786 statefuncs.py:134(<dictcomp>)
       ...
       75    0.000    0.000    0.000    0.000 signal.py:22(<lambda>)
        1    0.000    0.000    0.000    0.000 {function Random.seed at 0x7f27e3ed9400}
       36    0.000    0.000    0.000    0.000 context.py:254(<genexpr>)
        ...
        1    0.000    0.000    0.012    0.012 matrix.py:1(<module>)
       ...
       12    0.000    0.000    0.000    0.000 {built-in method builtins.next}
        ...
        1    0.000    0.000    0.000    0.000 statefuncs.py:10(phi4Info)
